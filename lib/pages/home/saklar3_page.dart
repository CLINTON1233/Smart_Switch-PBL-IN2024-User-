      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // Welcome Section untuk Ruang Tamu 3
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                  ...
                  Text(
                    'Kendalikan saklar ruang tamu 3',
                    style: GoogleFonts.poppins(
                      fontSize: 13,
              ...
              // Statistics Cards - disesuaikan untuk saklar 3
                 Row(
              children: [
              Expanded(
                child: Container(
